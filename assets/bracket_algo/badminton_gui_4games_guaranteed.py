...
def generate_final_4games_schedule(num_players, max_pair_overlap=2):
    ...
    while sum(player_game_count.values()) < total_participations_needed:
        slot_games = []
        used_players = set()
        sorted_groups = sorted(all_combinations, key=lambda g: calculate_overlap_score(g))
...
def display_schedule():
    ...
    schedule, players = generate_final_4games_schedule(num_players)
