...
import 'package:bracket_helper/presentation/create_partner_tournament/screens/partner_add_player/partner_add_player_screen.dart';
import 'package:flutter/material.dart';

class PartnerAddPlayerRoot extends StatefulWidget {
  final CreatePartnerTournamentViewModel viewModel;
  const PartnerAddPlayerRoot({super.key, required this.viewModel});

  @override
  State<PartnerAddPlayerRoot> createState() => _PartnerAddPlayerRootState();
}

class _PartnerAddPlayerRootState extends State<PartnerAddPlayerRoot> {
