...
import 'package:bracket_helper/presentation/create_partner_tournament/screens/create_partner_tournament_root.dart';
...
final router = GoRouter(
  ...
  redirect: (context, state) {
    ...
    if (state.uri.path == RoutePaths.savePlayer &&
        state.uri.queryParameters.containsKey('refresh')) {
  ...
  routes: [
    ...
    GoRoute(
      path: RoutePaths.createPartnerTournament,
      builder: (context, state) => const CreatePartnerTournamentRoot(),
      routes: [
        GoRoute(
          path: RoutePaths.partnerTournamentInfo,
          builder: (context, state) => const CreatePartnerTournamentRoot(),
        ),
        GoRoute(
          path: RoutePaths.partnerAddPlayer,
          builder: (context, state) => const CreatePartnerTournamentRoot(),
        ),
        GoRoute(
          path: RoutePaths.partnerEditMatch,
          builder: (context, state) => const CreatePartnerTournamentRoot(),
        ),
      ],
    ),
