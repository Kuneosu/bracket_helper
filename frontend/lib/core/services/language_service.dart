...
class LanguageService {
  ...
  static final ValueNotifier<String> languageChangeNotifier = ValueNotifier<String>(LanguageManager.currentLanguage);
  ...
  static void refreshApp(BuildContext context) {
    ...
    if (context.mounted) {
      ...
      Future.delayed(const Duration(milliseconds: 100), () {
        ...
        try {
          // HomeViewModel 갱신 시도
          if (getIt.isRegistered<ChangeNotifier>(instanceName: 'HomeViewModel')) {
            getIt<ChangeNotifier>(instanceName: 'HomeViewModel').notifyListeners();
          }
          
          // SavePlayerViewModel 갱신 시도
          if (getIt.isRegistered<ChangeNotifier>(instanceName: 'SavePlayerViewModel')) {
            getIt<ChangeNotifier>(instanceName: 'SavePlayerViewModel').notifyListeners();
          }
