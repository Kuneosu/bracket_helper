class AppStringsKo {
  ...
  static const String tournamentListLoadError = '토너먼트 목록을 불러오는 중 오류가 발생했습니다.';
  ...
  static const String tournamentDeleteError = '토너먼트 삭제 중 오류가 발생했습니다.';
  ...
  static const String storeOpenError = '스토어 페이지를 열 수 없습니다.';
...
''';
  ...
  static const String addPlayerToGroup = '%s에 선수 추가';
  static const String addPlayerLabel = '선수 이름';
  static const String addPlayerHint = '선수 이름을 입력하세요';
  static const String addPlayerError = '선수 이름을 입력해주세요';
  static const String addPlayerFeatureTitle = '여러 선수 한 번에 추가하기';
  static const String addPlayerFeatureGuide = '띄어쓰기로 구분하여 여러 명의 선수를 한 번에 등록할 수 있습니다.\n예: "홍길동 김철수"';
  static const String add = '추가';
  static const String error = '오류가 발생했습니다';
  static const String tryAgain = '다시 시도';
  static const String groupNotFound = '그룹을 찾을 수 없습니다';
  static const String groupNotFoundMessage = '그룹이 삭제되었거나 접근할 수 없습니다';
  static const String goToGroupList = '그룹 목록으로 돌아가기';
  ...
  static const String matchScoreInputInfo = "입력한 점수는 '경기 종료' 버튼을 눌러야 저장됩니다. 대진표를 수정하면 기존 점수가 초기화됩니다.";
  ...
  static const String isSaving = '저장 중...';
  static const String duplicatePlayerName = '이미 존재하는 이름입니다.';
  ...
  static const String partnerRequired = "최소 한 쌍 이상의 파트너를 지정해주세요.";
  static const String partnerPairOverLimit = "파트너 쌍 과다";
  static const String partnerPairOverLimitMessage = "홀수 인원(%d1명)에 고정 파트너 쌍이 너무 많습니다.\n\n%d1명일 경우 최대 %d2쌍까지만 고정 파트너를 지정할 수 있습니다.\n\n파트너 쌍 수를 줄이거나 선수를 한 명 더 추가하세요.";
  static const String matchGenerationFailed = "대진표 생성 실패";
  static const String matchGenerationFailedMessage = "지정된 파트너 쌍으로는 조건을 만족하는 대진표를 생성할 수 없습니다.\n\n다음 방법을 시도해보세요:\n- 파트너 쌍 수를 줄이기\n- 참가 인원 늘리기\n- 파트너 쌍을 다르게 지정하기";
  static const String partnerPairNoPlayer = "파트너 쌍을 설정할 선수가 없습니다.";
  static const String partnerPairNoPlayerSubText = "선수 목록 탭 또는 저장된 선수 탭에서\n먼저 선수를 추가해주세요.";
  static const String singleTournamentNoPartner = "단식 토너먼트에서는\n파트너 설정이 필요하지 않습니다.";
  static const String partnerPairs = "파트너 쌍";
